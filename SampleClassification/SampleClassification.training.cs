...
namespace SampleClassification.ConsoleApp
{
    public partial class SampleClassification
    {
        public const string RetrainFilePath =
            @"/home/cyberprophet/cli-test/sentiment labelled sentences/yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text
                .FeaturizeText(inputColumnName: @"col0", outputColumnName: @"col0")
                    ...
                    mlContext.MulticlassClassification.Trainers.OneVersusAll(
                        binaryEstimator: mlContext.BinaryClassification.Trainers.FastTree(
                            new FastTreeBinaryTrainer.Options()
                            {
                                ...
                                NumberOfTrees = 10,
                                MaximumBinCountPerFeature = 371,
                                FeatureFraction = 0.8414820359520164,
                                LearningRate = 0.892794957206889,
