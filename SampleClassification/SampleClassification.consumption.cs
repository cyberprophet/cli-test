...
namespace SampleClassification.ConsoleApp
{
    public partial class SampleClassification
    {
        ...
        public static IOrderedEnumerable<KeyValuePair<string, float>> PredictAllLabels(
            ModelInput input
        )
        {
        ...
        public static IOrderedEnumerable<KeyValuePair<string, float>> GetSortedScoresWithLabels(
            ModelOutput result
        )
        {
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            {
                throw new Exception(
                    "col1 column not found. Make sure the name searched for matches the name in the schema."
                );
            }
